...
class SwarnimVideoPlayer {
    ...
    init() {
        // Validate URL — reject javascript: and data: URIs to prevent XSS
        const url = (this.videoUrl || '').trim().toLowerCase();
        if (url.startsWith('javascript:') || url.startsWith('data:')) {
            console.error('SwarnimVideoPlayer: invalid or unsafe video URL rejected.');
            return;
        }
